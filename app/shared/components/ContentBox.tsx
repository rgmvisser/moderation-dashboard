...
export default function ContentBox({
  ...
  return (
    <li
      className={`flex w-full flex-col items-stretch justify-start gap-1 border-t-0 border-r-0 border-b border-l-0 border-main p-2 ${background} hover:bg-slate-50`}
    >
